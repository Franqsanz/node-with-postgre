...
import books from '../api/architectures/rest/routes/books';
import user from '../api/architectures/rest/routes/user';
import { jsonRpc } from '../api/architectures/json_rpc/http/server';
